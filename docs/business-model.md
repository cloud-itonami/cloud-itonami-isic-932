# Business Model: Amusement and Recreation Facility Operations Coordination
...
- ISIC Rev.5: `` — Amusement and Recreation Facility Operations Coordination
- Domain: `:services/amusement-facility-coordination`
- Social impact: :operational-efficiency :guest-safety :facility-safety
- Actor: `:amusementfacilityops-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :services/amusement-facility-coordination — who wants
...
Capability stack (required): :identity :forms :dmn :bpmn :audit-ledger.
...
One managed tenant (:services/amusement-facility-coordination):
...
- Do not bypass the `:amusementfacilityops-governor` for production decisions.
