# Operator Quickstart — cloud-itonami-isic-932

Shortest path from clone to a verified local dry-run for **ISIC 932** (`cloud-itonami-isic-932`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-932.git
...
- Likely source path: `amusementfacilityops.governor.cljc`
